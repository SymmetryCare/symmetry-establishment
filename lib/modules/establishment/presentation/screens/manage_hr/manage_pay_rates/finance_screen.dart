...
import 'package:symmetry_establishment/modules/establishment/presentation/screens/manage_hr/manage_pay_rates/widgets/custom_popup.dart';
...
import 'package:symmetry_establishment/modules/establishment/presentation/screens/widgets/table_constant.dart';
...
class FinanceProvider with ChangeNotifier {
  ...
  Future<void> loadHrData(BuildContext context) async {
    try {
      hrData = await getAllHrDeptWise(context, FrontendConfigStore.data!.config.clinicalId);
