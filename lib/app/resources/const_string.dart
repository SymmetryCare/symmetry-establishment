class AppString {
  ...
  static String upload_resume = "Upload Resume";
  ...
  static const String uploadLatterSalaried = "Upload Offer Letter (Salaried)";
  static const String uploadLatterPartTime = "Upload Offer Letter (Part Time)";
  static const String uploadLatterperDiem = "Upload Offer Letter (Per Diem)";
...
class AppStringSMModule {
  ...
  static const String moveIntakeReferNoData = 'No available move to intake referrals!';
  ...
  static const String infoUpdateNoData = 'No available information update data!';
  static const String sendToSchedNoData = 'No available send to scheduler data!';
  static const String NoAdmitData = 'No available non admit data!';
  static const String pendingNoData = 'No available schedular pending data!';
  static const String tobescheduleNoData = 'No available schedular to be scheduled data!';
  static const String scheduledNoData = 'No available scheduled data!';
  static const String noClinicalOffice = 'No available clinical data!';
}
