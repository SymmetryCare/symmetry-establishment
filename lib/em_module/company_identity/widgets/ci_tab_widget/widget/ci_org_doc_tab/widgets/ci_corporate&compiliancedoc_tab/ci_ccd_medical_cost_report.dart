...
class CiCcdMedicalCostReportProvider with ChangeNotifier {
  ...
  int docTypeMetaIdMCR =FrontendConfigStore.data!.config.subDocId3CICCMedicalCR;
    ...
    return StreamBuilder<List<NewOrgDocument>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.data == null || snapshot.data!.isEmpty) {
          return Center(child: Text(ErrorMessageString.noMCR, style: AllNoDataAvailable.customTextStyle(context)));
        }
